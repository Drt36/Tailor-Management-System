<%-- 
    Document   : recommendation_displayrecommended3piecesuitdesigns
    Created on : Mar 13, 2021, 10:31:31 PM
    Author     : dharm
--%>
...
<head>
        ...
        <link rel="stylesheet" href="CSS/recommendation_displayrecommended3piecesuitdesignsstyle.css" type="text/css">
    ...
    <div class="container text-left">
     ...
     <script type="text/javascript" src="Scripts/recommendation_displayrecommended3piecesuitdesigns.js"></script>
    </body>
</html>
