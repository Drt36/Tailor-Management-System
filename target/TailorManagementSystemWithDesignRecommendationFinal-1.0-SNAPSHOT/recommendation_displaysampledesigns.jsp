<%-- 
    Document   : recommendation_displaysampledesigns
    Created on : Mar 10, 2021, 6:46:25 AM
    Author     : dharm
--%>
...
<head>
        ...
        <link rel="stylesheet" href="CSS/recommendation_displaysampledesignsstyle.css" type="text/css">
    ...
    <div class="container text-left">
     ...
     <script type="text/javascript" src="Scripts/recommendation_displaysampledesigns.js"></script>
    </body>
</html>
