<%-- 
    Document   : users
    Created on : Oct 10, 2020, 8:53:24 AM
    Author     : dharm
--%>
   ...
   <a href="adminpanel.jsp">
    ...
    <div id="table">
       ...
       <div class="container text-left">
           ...
           <button id="adduserbutton" onclick="location.href='Registration.jsp'" type="button">Add New User</button>
        </div>
        <br>
        <h3 class="hide">${usercreatesuccessfullymessage}</h3>
        <h3 class="hide">${updateusermessage}</h3>
        <h3 class="hide">${deleteusermessage}</h3>
        <h3 class="hide">${unblockedsuccessfullymessage}</h3>
          <%
            //fetching list of all users
            AllUsersList alluserslist=new AllUsersList();
            List < User > listUser =alluserslist.selectAllUnblockedUsers();
            if(!listUser.isEmpty()){%> 
            <table id="t01">
                            ...
                            <%-- Arranging data in tabular form --%> 
                                <tr> 
                                    ...
                                    <td>
                                    <button onclick="location.href='adminsideeditprofileservlet?user_email=<%=user.getUser_email() %>'"  class="btn warning"/>Edit</button> &nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <button onclick="location.href='userblockservlet?user_email=<%=user.getUser_email()%>'" class="btn default" >Block</button>
                                    </td>
