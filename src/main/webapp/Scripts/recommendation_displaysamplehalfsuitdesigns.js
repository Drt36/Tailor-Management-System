...
xhr.open('GET','https://api-test-tmswdr.herokuapp.com/samplehalfsuit', true);
    ...
    if (this.status === 200) {
        ...
        json.forEach(function(element,index){
            ...
            <div class="container">
              ...
              <br>
              <form action="recommendation_displayrecommendedhalfsuitdesignservlet" id="beforerecommendform" method="post">
