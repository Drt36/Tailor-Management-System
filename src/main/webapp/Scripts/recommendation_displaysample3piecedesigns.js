 ...
 */
/* global firstdiv, seconddiv, thirddiv, fourthdiv */

console.log("This is sample design page");

// Create an ajax get request
const xhr = new XMLHttpRequest();
xhr.open('GET','https://api-test-tmswdr.herokuapp.com/sample3piecesuit', true);
    ...
    if (this.status === 200) {
        ...
        json.forEach(function(element,index){
            ...
            <div class="container">
              ...
              <br>
              <form action="recommendation_displayrecommended3piecesuitdesignservlet" id="beforerecommendform" method="post">
               ...
               <form action="order_afterproductselectservlet" id="beforeorderform" method="post">
                  <input type="hidden" name="customer_email_id"value="${customer_email}" >
                  <input type="hidden" name="product_code_id" value="${product_code}">
                  <input type="hidden" name="design_url_id" value="${element["Design_url"]}">
