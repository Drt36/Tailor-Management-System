 ...
 */
/* global firstdiv, seconddiv, thirddiv, fourthdiv, sixdiv, sevendiv, fivediv, eightdiv */

console.log("This is recommended design page");

var design_url=document.getElementById("design_url_id").value;
var design_code=document.getElementById("design_code_id").value;
// Create an ajax get request
const xhr = new XMLHttpRequest();
xhr.open('GET','https://api-test-tmswdr.herokuapp.com/recommendation3piecesuit?Design_codein='+design_code, true);
             ...
             if(count===1){
                ...
                seconddiv.innerHTML = designHtml;
                 ...
                 thirddiv.innerHTML = designHtml;
                  ...
                  fivediv.innerHTML = designHtml;

             }
             else if(count===6){
                  sixdiv.innerHTML = designHtml;

             }
             else if(count===7){
                  sevendiv.innerHTML = designHtml;

             }
             else if(count===8){
                  eightdiv.innerHTML = designHtml;
