<%-- 
    Document   : recommendation_displayrecommendedhalfsuitdesigns
    Created on : Mar 13, 2021, 10:31:11 PM
    Author     : dharm
--%>
...
<head>
        ...
        <link rel="stylesheet" href="CSS/recommendation_displayrecommendedhalfsuitdesignsstyle.css" type="text/css">
    ...
    <div class="container text-left">
     ...
     <script type="text/javascript" src="Scripts/recommendation_displayrecommendedhalfsuitdesigns.js"></script>
    </body>
</html>
