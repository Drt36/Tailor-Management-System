<%-- 
    Document   : recommendation_display3piecesuitsampledesigns
    Created on : Mar 13, 2021, 10:30:41 PM
    Author     : dharm
--%>
...
<head>
        ...
        <link rel="stylesheet" href="CSS/recommendation_displaysample3piecesuitdesignsstyle.css" type="text/css">
    ...
    <div class="container text-left">
     ...
     <script type="text/javascript" src="Scripts/recommendation_displaysample3piecedesigns.js"></script>
    </body>
</html>
