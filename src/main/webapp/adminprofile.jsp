<%-- 
    ...
    Created on : Nov 5, 2020, 8:49:32 AM
    Author     : dharm
--%>
      ...
      <%}
       ...
       <div>
        ...
        <div>
            ...
            <form id="profileform" method="post" action="<%= request.getContextPath()%>/adminprofilephotouploadservlet" enctype="multipart/form-data">
