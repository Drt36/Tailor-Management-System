<%-- 
    Document   : otpcodevalidation
    Created on : Oct 30, 2020, 10:44:28 PM
    Author     : dharm
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="Scripts/Otpcodecheck.js"></script>
    </head>
    <body>
        ...
        <form id="codevalidationform" action="<%= request.getContextPath() %>/codevalidationservlet" method="post">
                <div class="container">
