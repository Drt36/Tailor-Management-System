<%-- 
    ...
    Created on : Nov 7, 2020, 9:21:06 AM
    Author     : dharm
--%>
...
<html>
   <head>
            ...
            <link rel="stylesheet" href="CSS/editprofilestyle.css" type="text/css">
    ...
    <%  
     ...
     %>
        ...
        <form action="<%= request.getContextPath()%>/editprofilesaveservlet" class="was-validated" id="editprofileform" method="post">
                <div class="container">
                    ...
                    <input type="hidden" name="user_role_id" value="<%=user.getUser_role() %>">
                  ...
                  <div class="form-group form-check">
                    ...
                    <input type="submit" id="editprofilesubmit" value="Submit"></input>
              </form>
</html>
