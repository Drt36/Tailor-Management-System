 ...
 * @author dharm
 */
@WebServlet(name = "Otpcodecheckservletforforgetpassword", urlPatterns = {"/Otpcodecheckservletforforgetpassword"})
public class Otpcodecheckservletforforgetpassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Otpcodecheckservletforforgetpassword</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Otpcodecheckservletforforgetpassword at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
