 ...
 * @author dharm
 */
@WebServlet(name = "staffprofilephotouploadservlet", urlPatterns = {"/staffprofilephotouploadservlet"})
@MultipartConfig(maxFileSize = 16177215)
public class staffprofilephotouploadservlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet staffprofilephotouploadservlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet staffprofilephotouploadservlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(staffprofilephotouploadservlet.class.getName()).log(Level.SEVERE, null, ex);
