 ...
 * @author dharm
 */
@WebServlet(name = "order_completedservlet", urlPatterns = {"/order_completedservlet"})
public class order_completedservlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet order_completedservlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet order_completedservlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            storehistory.storeHistory(user_email,"Order Completed: "+order_id, datetime);
            
            request.setAttribute("ordercompletedmessage","Order has been completed Successfully");
            ...
            Logger.getLogger(order_completedservlet.class.getName()).log(Level.SEVERE, null, ex);
