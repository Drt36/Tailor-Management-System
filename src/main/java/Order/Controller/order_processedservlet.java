 ...
 * @author dharm
 */
@WebServlet(name = "order_processedservlet", urlPatterns = {"/order_processedservlet"})
public class order_processedservlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet order_processedservlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet order_processedservlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            storehistory.storeHistory(user_email,"Order Processed: "+order_id, datetime);
            
            
            request.setAttribute("orderprocessedmessage","Order has been processed Successfully");
            ...
            Logger.getLogger(order_processedservlet.class.getName()).log(Level.SEVERE, null, ex);
